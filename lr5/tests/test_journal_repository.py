def test_all(journal_repository, example_logs):
    logs = journal_repository.get_all()
...
def test_all_with_id(journal_repository, example_logs):
    test_user_id = example_logs[0].user_id
    logs = journal_repository.get_all_with_user_id(test_user_id)
...
def test_get_total_count_with_id(journal_repository, example_logs):
    test_user_id = example_logs[0].user_id
    total_count = journal_repository.get_total_count_with_user_id(test_user_id)
...
def test_get_page_with_id(journal_repository, example_logs):
    test_per_page = 10
    test_page = 1
    test_user_id = example_logs[0].user_id

    pages = journal_repository.get_page_with_user_id(test_user_id, test_per_page, test_page)
...
def test_log_user_aggregation(journal_repository, example_logs, user_repository):
    ...
    for stat in example_logs:
        if stat.user_id == None:
            ...
            user_data = user_repository.get_with_id(stat.user_id)
