...
function modalShown(event) {
    ...
    let firstName = rowElements.children.item(2).textContent;
    let middleName = rowElements.children.item(3).textContent;
    let lastName = rowElements.children.item(1).textContent;
